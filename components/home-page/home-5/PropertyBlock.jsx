...
const properties = [
  {
    imgSrc: `/images/gallery/punta-palmera/DSC_8377.jpg`,
    name: "Punta Palmera",
  ...
  },
  {
    ...
    address:
      "Modern and cozy apartment in Punta Cana - Vista Cana, perfect for couples, small families, or up to 4 guests.",
  ...
  },
  {
    ...
    address:
      "A modern, cozy & fully equipped apartment – ideal for couples, small families, or groups up to 4 guests.",
            ...
            <div className="card-style-twentyTwo mt-35 home-property-container">
              ...
              <div className="text-meta">
                ...
                <div className="d-flex align-items-center justify-content-between arrow-property-wrapper">
                  <span className="read-more tran3s">
